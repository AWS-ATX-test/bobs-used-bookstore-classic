...
namespace Bookstore.Web.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        {
            var shoppingCart = await shoppingCartService.GetShoppingCartAsync(HttpContext.TraceIdentifier);
        ...
        {
            var dto = new DeleteShoppingCartItemDto(HttpContext.TraceIdentifier, shoppingCartItemId);
